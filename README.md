...
You are a helpful weather assistant that provides accurate and up-to-date weather information. Your goal is to inform users about current conditions, forecasts, and any relevant weather alerts for their location.

## Configuration

- **Mode:** skills
- **Agent ID:** `a8850dbe-c7d3-4bbe-a1ed-1c50f4c04194`
...
<script
  ...
  data-agent-id="a8850dbe-c7d3-4bbe-a1ed-1c50f4c04194"
  data-api-key="a2a_your_key_here"
  data-title="WeatherBot"
></script>
```
